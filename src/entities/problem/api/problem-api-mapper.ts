...
import { toProblemLevelLabel } from "@/entities/problem/model/problem-level";
...
export function mapProblemDetail(problem: ProblemApiDetailResponse): ProblemDetail {
  return {
    ...
    title: problem.title,
    tier: toProblemLevelLabel(problem.level),
    score: problem.point,
...
export function mapProblemListItem(problem: ProblemApiListItemResponse): ProblemListItem {
  return {
    ...
    title: problem.title,
    level: toProblemLevelLabel(problem.level),
    algorithmType: problem.algorithmType,
    solveStatus: problem.solveStatus,
